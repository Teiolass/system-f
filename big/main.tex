...
\begin{block}[Proposizione]
    ...
    comparire in $\overline{x}$). Vale che un termine \`e in forma normale se e
    solo se \`e in forma normale di testa e gli $u_i$ della notazione appena
    introdotta sono termini in forma normale per ogni $i$.
\end{block}
\begin{proof}
